...
public class _BankServerInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements common.BankServerInterface
{
  ...
  public void deposit (String customerID, double amount) throws common.BankServerInterfacePackage.invalid_client, common.BankServerInterfacePackage.invalid_bankOperation
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public void withdraw (String customerID, double amount) throws common.BankServerInterfacePackage.invalid_client, common.BankServerInterfacePackage.invalid_bankOperation
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
